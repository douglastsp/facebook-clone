    ...
    <div id="MainNav" class="fixed z-50 w-full flex items-center justify-between h-[56px] bg-white shadow-xl border-b">
        ...
        <div id="NavCenter" class="hidden lg:flex items-center ml-5 justify-center w-8/12 max-w-[600px]">
            <Link href="/" class="w-full">
                <!-- $page is a global variable from inertia -->
                <div
        ...
        <div class="flex items-center justify-end w-2/12 mr-4">
            ...
            <div class="flex items-center justify-center relative">
                <button @click="showMenu = !showMenu">
                    <img src="https://picsum.photos/id/87/300/320" alt="" class="rounded-full ml-1 min-w-[40px] max-h-[40px] cursor-pointer">
                </button>
                <!-- Menu -->
                <div
                    v-if="showMenu" 
                    class="absolute bg-white shadow-xl top-10 right-0 w-[330px] p-1 rounded-lg border mt-1"
                >
                    <Link href="/" @click="showMenu = !showMenu">
                        <div class="flex items-center gap-3 hover:bg-gray-200 p-2 rounded-lg">
                            <img src="https://picsum.photos/id/87/300/320" alt="" class="rounded-full ml-1 min-w-[35px] max-h-[35px] cursor-pointer">
                            <span>
                                Douglas Teixeira
                            </span>
                        </div>

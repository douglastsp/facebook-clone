                ...
                <div class="border-t border-t-gray-300">
                    <div class="p-4">
                        <div class="flex items-center">
                            <img src="https://picsum.photos/id/87/300/320" class="rounded-full ml-1 min-w-[45px] max-h-[45px]">
                            <div class="ml-4">
                        ...
                        <div class="max-h-[350px] overflow-auto">
                            <textarea
                                ...
                                rows="3"
                            ></textarea>
                            <div v-if="form.image" class="p-2 border-gray-300 rounded-lg relative">
                                <Close 
                                    @click="clearImage()"
